...
You can override the submit button on ```edit-add.blade.php``` by extending ```submit-buttons``` section. 
#### Example:
`resources/views/vendor/voyager/slug-name/edit-add.blade.php`
```blade
