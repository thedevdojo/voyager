...
class CreateDataTypesTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('data_types', function (Blueprint $table) {
            ...
            $table->string('model_name')->charset('latin1')->collate('latin1_general_ci')->nullable();
        ...
        Schema::create('data_rows', function (Blueprint $table) {
            ...
            $table->string('field')->charset('latin1')->collate('latin1_general_ci');
            $table->string('type')->charset('latin1')->collate('latin1_general_ci');
