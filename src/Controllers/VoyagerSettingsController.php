...
class VoyagerSettingsController extends Controller {
	...
	public function move_up(Request $request, $id){
		...
		if(isset($previous_setting->order)){
			...
			return back()->with(array('message' => 'Moved ' . $setting->display_name . ' setting order up', 'alert-type' => 'success'));
		} else {
	...
	public function delete_value($id){
		...
		return back()->with(array('message' => 'Successfully removed ' . $setting->display_name . ' value', 'alert-type' => 'success'));
	}
	...
	public function move_down(Request $request, $id){
		...
		if(isset($previous_setting->order)){
			...
			return back()->with(array('message' => 'Moved ' . $setting->display_name . ' setting order down', 'alert-type' => 'success'));
		} else {
			return back()->with(array('message' => 'This is already at the bottom of the list', 'alert-type' => 'error'));
		}
	}
