...
class VoyagerUserController extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    eval('$dataTypeContent = ' . $dataType->model_name . '::with("roles")->get();');
  ...
  public function show(Request $request, $id)
  {
    ...
    if(view()->exists('admin.' . $slug . '.read')){
      return view('admin.' . $slug . '.read', array('dataType' => $dataType, 'dataTypeContent' => $dataTypeContent)); 
    } else if (view()->exists('voyager::' . $slug . '.read')) {
      return view('voyager::' . $slug . '.read', array('dataType' => $dataType, 'dataTypeContent' => $dataTypeContent));
    } else {
  ...
  public function edit(Request $request, $id)
  {
    ...
    if(view()->exists('admin.' . $slug . '.edit-add')){
      ...
      return view('voyager::bread.edit-add', array('dataType' => $dataType, 'dataTypeContent' => $dataTypeContent, 'roles' => $roles));
    }
