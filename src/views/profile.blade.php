...
@section('content')
    <div style="background-image:url({{ config('voyager.assets_path') }}/images/bg.jpg); background-size:cover; background-position:center center; position:absolute; top:0; left:0; width:100%; height:300px;"></div>
