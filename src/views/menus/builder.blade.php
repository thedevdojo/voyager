...
@section('page_header')
    <h1 class="page-title">
        ...
        <div class="btn btn-success add_item"><i class="fa fa-plus-circle"></i> New Menu Item</div>
    </h1>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-trash-o"></i> Are you sure you want to delete this menu
                        item?</h4>
                </div>
    ...
    <div class="modal modal-success fade" tabindex="-1" id="add_modal" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('voyager.menu.add_item') }}" id="add_form" method="POST">
