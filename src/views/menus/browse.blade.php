...
@section('page_header')
	<h1 class="page-title">
		<i class="voyager-list-add"></i> {{ $dataType->display_name_plural }} <a href="{{ route($dataType->slug.'.create') }}" class="btn btn-success"><i class="voyager-plus"></i> Add New</a>
	</h1>
@stop
					   		...
					   		@foreach($dataTypeContent as $data)
					      		<tr>
					      			...
					      			<td class="no-sort no-click">
										...
										<a href="{{ route('menus.edit', $data->id) }}" class="btn-sm btn-primary pull-right edit"><i class="voyager-edit"></i> Edit</a>
										<a href="{{ route('voyager.menu.builder', $data->id) }}" class="btn-sm btn-success pull-right"><i class="voyager-list"></i> Builder</a>
									</td>
					      		</tr>
					      	@endforeach
					    </tbody>
