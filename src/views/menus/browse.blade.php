...
@section('css')
    <!-- DataTables -->
    <link rel="stylesheet"
          href="{{ config('voyager.assets_path') }}/remark/global/vendor/datatables-bootstrap/dataTables.bootstrap.css">
    <link rel="stylesheet"
          href="{{ config('voyager.assets_path') }}/remark/global/vendor/datatables-responsive/dataTables.responsive.css">
@stop

@section('page_header')
    <h1 class="page-title">
        <i class="voyager-list-add"></i> {{ $dataType->display_name_plural }} <a
                href="/admin/{{ $dataType->slug }}/create" class="btn btn-success"><i class="fa fa-plus-circle"></i> Add
            New</a>
    </h1>
@stop
                            ...
                            @foreach($dataTypeContent as $data)
                                <tr>
                                    ...
                                    <td class="no-sort no-click">
                                        <div class="btn-sm btn-danger pull-right delete" data-id="{{ $data->id }}"><i
                                                    class="fa fa-trash"></i> Delete
                                        </div>
                                        <a href="/admin/{{ $dataType->slug }}/{{ $data->id }}/edit"
                                           class="btn-sm btn-primary pull-right edit"><i class="fa fa-edit"></i>
                                            Edit</a> <a href="/admin/{{ $dataType->slug }}/{{ $data->id }}/builder"
                                                        class="btn-sm btn-success pull-right"><i class="fa fa-list"></i>
                                            Builder</a></td>
                                </tr>
                            @endforeach
                            </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-trash-o"></i> Are you sure you want to delete
