...
@section('page_header')
	<h1 class="page-title">
		<i class="voyager-list-add"></i> {{ $dataType->display_name_plural }} <a href="/admin/{{ $dataType->slug }}/create" class="btn btn-success"><i class="voyager-plus"></i> Add New</a>
	</h1>
@stop
					    ...
					    <tbody>
					   		@foreach($dataTypeContent as $data)
					      		<tr>
					      			...
					      			@endforeach
					      			<td class="no-sort no-click"><div class="btn-sm btn-danger pull-right delete" data-id="{{ $data->id }}"><i class="voyager-trash"></i> Delete</div><a href="/admin/{{ $dataType->slug }}/{{ $data->id }}/edit" class="btn-sm btn-primary pull-right edit"><i class="voyager-edit"></i> Edit</a> <a href="/admin/{{ $dataType->slug }}/{{ $data->id }}/builder" class="btn-sm btn-success pull-right"><i class="voyager-list"></i> Builder</a></td>
					      		</tr>
					      	@endforeach
					    </tbody>
					</table>
