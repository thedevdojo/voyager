        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <!-- form start -->
                    <form role="form"
                          action="@if(isset($dataTypeContent->id)){{ '/admin/' . $dataType->slug . '/' . $dataTypeContent->id }}@else{{ '/admin/' . $dataType->slug }}@endif"
                                ...
                                <div class="form-group">
                                    ...
                                    @if($row->type == "text")
                                        <input type="text" class="form-control" name="{{ $row->field }}"
                                               ...
                                               value="@if(isset($dataTypeContent->{$row->field})){{ $dataTypeContent->{$row->field} }}@endif">
                                    ...
                                    @elseif($row->type == "text_area")
                                        <textarea class="form-control"
                                                  name="{{ $row->field }}">@if(isset($dataTypeContent->{$row->field})){{ $dataTypeContent->{$row->field} }}@endif</textarea>
