...
@section('content')
    ...
    <div class="page-content">
        ...
        <div style="padding:15px;">
              ...
              @else
                <p style="border-radius:4px; padding:20px; background:#fff; margin:0px; color:#999; text-align:center;">To view analytics you'll need to get a google analytics client id and add it to your settings for the key <code>google_analytics_client_id</code>. Get your key in your Google developer console: <a href="https://console.developers.google.com" target="_blank">https://console.developers.google.com</a></p>
              @endif
