...
@section('content')
  ...
  <table class="table table-bordered" style="width:100%; display:none;">
    ...
    <div class="page-content container-fluid">  
        <div class="row">
            <div class="col-md-12">
              <form action="@if(isset($table)){{ '/admin/database/edit-table' }}@else{{ '/admin/database/create-table' }}@endif" method="POST">
                    ...
                    <div class="panel-body">
                          ...
                          <div class="row">
                              ...
                              @endif
                                  ...
                                  <input type="text" name="name" class="form-control" placeholder="Table Name" value="@if(isset($table)){{ $table }}@endif">
                                  @if(isset($table))
                              ...
                              @if(!isset($table))
                                <div class="col-md-6">
                                    ...
                                    <input type="checkbox" name="create_model" data-toggle="toggle" data-on="Yes, Please" data-off="No Thanks">
                      ...
                      <div class="panel-footer">
                          <input type="submit" class="btn btn-primary pull-right" value="@if(isset($table)){{ 'Update Table' }}@else{{ 'Create New Table' }}@endif">
...
<script>
    ...
    function getCorrectType(type){
      if(type.substring(0, 3) == 'int'){ return 'integer'; }
      if(type.substring(0, 7) == 'varchar'){ return 'string'; }
      if(type == 'tinyint(1)'){ return 'boolean'; }
      if(type.substring(0, 7) == 'tinyint'){ return 'tinyInteger'; }
      if(type.substring(0, 8) == 'smallint'){ return 'smallInteger'; }
      if(type.substring(0, 9) == 'mediumint'){ return 'mediumInteger'; }
      if(type.substring(0, 6) == 'bigint'){ return 'bigInteger'; }
      if(type == 'mediumtext'){ return 'mediumText'; }
      if(type == 'longtext'){ return 'longText'; }
      if(type == 'double(8,2)'){ return 'float' }
      if(type.substring(0, 7) == 'decimal'){ return 'decimal'; }
