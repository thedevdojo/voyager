            ...
            <form role="form" action="@if(isset($dataType->id)){{ '/admin/database/' . $dataType->id . '/edit-bread' }}@else{{ '/admin/database/store_bread' }}@endif" method="POST">
                ...
                <div class="panel panel-primary panel-bordered">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                          <label for="email">Icon (optional) Use a <a href="{{ asset(config('voyager.assets_path') . '/fonts/voyager/icons-reference.html') }}" target="_blank">Voyager Font Class</a></label>
