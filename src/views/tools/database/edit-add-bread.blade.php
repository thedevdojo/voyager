                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="slug" placeholder="URL slug (ex. posts)"
                                       value="@if(isset($dataType->slug)){{ $dataType->slug }}@endif">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="display_name_singular"
                                       ...
                                       value="@if(isset($dataType->display_name_singular)){{ $dataType->display_name_singular }}@endif">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="display_name_plural"
                                       ...
                                       value="@if(isset($dataType->display_name_plural)){{ $dataType->display_name_plural }}@endif">
                            </div>
                            <div class="form-group">
