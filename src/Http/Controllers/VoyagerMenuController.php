...
class VoyagerMenuController extends Controller
{
    ...
    public function delete_menu($menu, $id)
    {
        ...
        return redirect()
            ...
            ->with([
                'message'    => __('voyager::voyager.menu_builder.successfully_deleted'),
                'alert-type' => 'success',
            ]);
    }
    ...
    public function add_item(Request $request)
    {
        ...
        return redirect()
            ...
            ->with([
                'message'    => __('voyager::voyager.menu_builder.successfully_created'),
                'alert-type' => 'success',
            ]);
    }
    ...
    public function update_item(Request $request)
    {
        ...
        return redirect()
            ...
            ->with([
                'message'    => __('voyager::voyager.menu_builder.successfully_updated'),
                'alert-type' => 'success',
            ]);
    }
