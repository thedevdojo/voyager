...
class VoyagerBreadController extends Controller
{
    ...
    public function order(Request $request)
    {
        ...
        if (!isset($dataType->order_column) || empty($dataType->order_column)
        || !isset($dataType->order_ident_column) || empty($dataType->order_ident_column)) {
            return redirect()
            ->route("voyager.{$dataType->slug}.index")
            ->with([
                'message'    => __('voyager.database.ordering_not_set'),
                'alert-type' => 'error',
            ]);
        }
