...
class DatabaseTest extends TestCase
{
    ...
    public function test_table_created_successfully()
    {
        ...
        $this->assertSessionHasAll($this->alertSuccess(__('voyager::voyager.database.success_create_table', ['table' => $this->table['name']])));
    ...
    public function test_can_drop_table()
    {
        ...
        // Test correct response
        $this->assertSessionHasAll($this->alertSuccess(__('voyager::voyager.database.success_delete_table', ['table' => $this->table['name']])));
        $this->assertRedirectedToRoute('voyager.database.index');
    ...
    protected function update_table(array $table)
    {
        ...
        // Test correct response
        $this->assertSessionHasAll($this->alertSuccess(__('voyager::voyager.database.success_create_table', ['table' => $table['name']])));
        $this->assertRedirectedToRoute('voyager.database.index');
