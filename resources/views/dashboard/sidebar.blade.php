    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="side-menu-container">
            <div class="navbar-header">
                <a class="navbar-brand" href="{{ route('voyager.dashboard') }}">
                    <div class="logo-icon-container">
                        ...
                        @if($admin_logo_img == '')
                            <img src="{{ asset( config('voyager.asset_path') . 'images/logo-icon-light.png') }}"
                                 alt="Logo Icon">
                        @else
            ...
            <div class="panel widget center bgimage"
                 style="background-image:url({{ Voyager::image( Voyager::setting('admin.bg_image'), asset( config  ('voyager.asset_path') . 'images/bg.jpg') ) }});
