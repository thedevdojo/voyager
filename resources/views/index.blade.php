...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{ url('/vendor/tcg/voyager/assets') }}/css/ga-embed.css">
@stop
...
@section('javascript')
    ...
    @if(isset($google_analytics_client_id) && !empty($google_analytics_client_id))
        ...
        <script src="{{ url('/vendor/tcg/voyager/assets') }}/js/ga-embed/chart.min.js"></script>
        <script src="{{ url('/vendor/tcg/voyager/assets') }}/js/ga-embed/moment.min.js"></script>
        <!-- Include the ViewSelector2 component script. -->
        <script src="{{ url('/vendor/tcg/voyager/assets') }}/js/ga-embed/view-selector2.js"></script>
        <!-- Include the DateRangeSelector component script. -->
        <script src="{{ url('/vendor/tcg/voyager/assets') }}/js/ga-embed/date-range-selector.js"></script>
        <!-- Include the ActiveUsers component script. -->
        <script src="{{ url('/vendor/tcg/voyager/assets') }}/js/ga-embed/active-users.js"></script>
