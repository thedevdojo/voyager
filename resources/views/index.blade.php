            ...
            <div class="Dashboard Dashboard--full" id="analytics-dashboard">
                ...
                <ul class="FlexGrid FlexGrid--halves">
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('voyager::admin.This year vs last year') }}</h1>
                                <div class="Titles-sub">{{ __('voyager::admin.By users') }}</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('voyager::admin.Top browsers') }}</h1>
                                <div class="Titles-sub">{{ __('voyager::admin.By pageview') }}</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('voyager::admin.Top countries') }}</h1>
                                <div class="Titles-sub">{{ __('voyager::admin.By sessions') }}</div>
                            </header>
