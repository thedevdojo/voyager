        ...
        <div class="analytics-container">
            ...
            @else
                <p style="border-radius:4px; padding:20px; background:#fff; margin:0; color:#999; text-align:center;">
                    {!! __('voyager::voyager.analytics.no_client_id') !!}
            ...
            <div class="Dashboard Dashboard--full" id="analytics-dashboard">
                <header class="Dashboard-header">
                    <ul class="FlexGrid">
                        <li class="FlexGrid-item">
                            <div class="Titles">
                                <h1 class="Titles-main" id="view-name">{{ __('voyager::voyager.analytics.select_view') }}</h1>
                                <div class="Titles-sub">{{ __('voyager::voyager.analytics.various_visualizations') }}</div>
                            </div>
                        </li>
                ...
                <ul class="FlexGrid FlexGrid--halves">
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('voyager::voyager.analytics.this_vs_last_week') }}</h1>
                                <div class="Titles-sub">{{ __('voyager::voyager.analytics.by_users') }}</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('voyager::voyager.analytics.this_vs_last_year') }}</h1>
                                <div class="Titles-sub">{{ __('voyager::voyager.analytics.by_users') }}</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('voyager::voyager.analytics.top_browsers') }}</h1>
                                <div class="Titles-sub">{{ __('voyager::voyager.analytics.by_pageview') }}</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('voyager::voyager.analytics.top_countries') }}</h1>
                                <div class="Titles-sub">{{ __('voyager::voyager.analytics.by_sessions') }}</div>
                            </header>
                ...
                function renderWeekOverWeekChart(ids) {
                    ...
                    Promise.all([thisWeek, lastWeek]).then(function (results) {
                        ...
                        var data = {
                            ...
                            datasets: [
                                {
                                    label: '{{ __('voyager::voyager.date.last_week') }}',
                                ...
                                {
                                    label: '{{ __('voyager::voyager.date.this_week') }}',
                ...
                function renderYearOverYearChart(ids) {
                    ...
                    Promise.all([thisYear, lastYear]).then(function (results) {
                        ...
                        var data = {
                            ...
                            datasets: [
                                {
                                    label: '{{ __('voyager::voyager.date.last_year') }}',
                                    fillColor: 'rgba(220,220,220,0.5)',
                                    strokeColor: 'rgba(220,220,220,1)',
                                    data: data2
                                },
                                {
                                    label: '{{ __('voyager::voyager.date.this_year') }}',
                                    fillColor: 'rgba(151,187,205,0.5)',
                                    strokeColor: 'rgba(151,187,205,1)',
                                    data: data1
                                }
