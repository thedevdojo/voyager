...
<div class="row row-dd row-dd-relationship">
    <div class="col-xs-2">
        ...
        <strong>{{ __('voyager::voyager.database.type') }}:</strong> <span>{{ __('voyager::voyager.database.relationship.relationship') }}</span>
        <div class="handler voyager-handle"></div>
    ...
    <div class="col-xs-2">
        ...
        <label for="field_browse_{{ $relationship['field'] }}"> {{ __('voyager::voyager.database.relationship.browse') }}</label><br>
        ...
        <label for="field_read_{{ $relationship['field'] }}"> {{ __('voyager::voyager.database.relationship.read') }}</label><br>
        ...
        <label for="field_edit_{{ $relationship['field'] }}"> {{ __('voyager::voyager.database.relationship.edit') }}</label><br>
        ...
        <label for="field_add_{{ $relationship['field'] }}"> {{ __('voyager::voyager.database.relationship.add') }}</label><br>
        ...
        <label for="field_delete_{{ $relationship['field'] }}"> {{ __('voyager::voyager.database.relationship.delete') }}</label><br>
    </div>
    <div class="col-xs-2">
        <p>{{ __('voyager::voyager.database.relationship.relationship') }}</p>
    </div>
    <div class="col-xs-2">
    ...
    <div class="col-xs-4">
        <div class="voyager-relationship-details-btn">
            ...
            <span class="open_text">{{ __('voyager::voyager.database.relationship.open') }}</span>
            <span class="close_text">{{ __('voyager::voyager.database.relationship.close') }}</span>
            {{ __('voyager::voyager.database.relationship.relationship_details') }}
        </div>
    </div>
    <div class="col-md-12 voyager-relationship-details">
        ...
        <div class="relationship_details_content">
            ...
            <span><input type="text" class="form-control" name="relationship_model_{{ $relationship['field'] }}" placeholder="{{ __('voyager::voyager.database.relationship.namespace') }}" value="@if(isset($relationshipDetails->model)){{ $relationshipDetails->model }}@endif"></span>
        </div>
        ...
        <div class="relationship_details_content margin_top">
            <label>{{ __('voyager::voyager.database.relationship.display_the') }} <span class="label_table_name"></span></label>
            ...
            <label class="relationship_key" style="@if($relationshipDetails->type == 'belongsTo' || $relationshipDetails->type == 'belongsToMany'){{ 'display:block' }}@endif">{{ __('voyager::voyager.database.relationship.store_the') }} <span class="label_table_name"></span></label>
