    ...
    <div class="flex flex-col justify-start">
        ...
        <nav class="text-gray-500 px-5 mt-4">
            ...
            @if (count(Bread::getBreads()) > 0)
                ...
                <a href="{{ route('voyager.'.$bread->slug.'.browse') }}" class="item">
