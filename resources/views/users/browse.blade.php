                                ...
                                <tr>
                                    ...
                                    <td class="no-sort no-click">
                                        @if (Voyager::can('delete_'.$dataType->name))
                                            <div class="btn-sm btn-danger pull-right delete" data-id="{{ $data->getKey() }}" id="delete-{{ $data->getKey() }}">
                                                <i class="voyager-trash"></i> {{ __('voyager.generic.delete') }}
                                            </div>
                                        @endif
                                        @if (Voyager::can('edit_'.$dataType->name))
                                            <a href="{{ route('voyager.'.$dataType->slug.'.edit', $data->getKey()) }}" class="btn-sm btn-primary pull-right edit">
                                                <i class="voyager-edit"></i> {{ __('voyager.generic.edit') }}
                                            </a>
                                        @endif
                                        @if (Voyager::can('read_'.$dataType->name))
                                            <a href="{{ route('voyager.'.$dataType->slug.'.show', $data->getKey()) }}" class="btn-sm btn-warning pull-right">
