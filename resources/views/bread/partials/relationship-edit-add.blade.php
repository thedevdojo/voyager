...
<tr>
    ...
    @endforeach
    <td class="danger">
        <button type="button" class="close form-control btn-remove-bread-relationship" aria-label="{{ __('voyager::voyager.generic.close') }}"><span aria-hidden="true" class="glyphicon glyphicon-remove"></span></button>
    </td>
</tr>
</tr>
</script>
