...
*/
        if (file_exists(app_path('User.php'))) {
            ...
            //I lazily assume this is the only other place it could be. Maybe we should search it out instead
        ...
        if ($str !== false) {
            ...
            file_put_contents($userPath, $str);    //(app_path('User.php'), $str);
        
        } else {
            $this->warn('Unable to locate "app/User.php" or "app\Models\User.php".  Did you move this file?');
