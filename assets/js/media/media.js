...
$(function(){
	...
	$('#new_folder_submit').click(function(){
		...
		$.post('/admin/media/new_folder', { new_folder: new_folder_path, _token: CSRF_TOKEN }, function(data){
	...
	$('#confirm_delete').click(function(){
		...
		$.post('/admin/media/delete_file_folder', { folder_location: manager.folders, file_folder: manager.selected_file.name, type: manager.selected_file.type, _token: CSRF_TOKEN }, function(data){
			if(data.success == true){
	...
	$('#move_btn').click(function(){
		...
		$.post('/admin/media/move_file', { folder_location: manager.folders, source: source, destination: destination, _token: CSRF_TOKEN }, function(data){
			if(data.success == true){
	...
	$('#rename_btn').click(function(){
		...
		$.post('/admin/media/rename_file', { folder_location: manager.folders, filename: filename, new_filename: new_filename, _token: CSRF_TOKEN }, function(data){
			if(data.success == true){
	...
	function getFiles(folders){
		...
		$('#file_loader').fadeIn();
		$.post('/admin/media/files', { folder:folder_location, _token: CSRF_TOKEN, _token: CSRF_TOKEN }, function(data) {
			$('#file_loader').hide();
			manager.files = data;
		...
		var all_folders = '';
		$.post('/admin/media/directories', { folder_location:manager.folders, _token: CSRF_TOKEN }, function(data){
			console.log(data);
