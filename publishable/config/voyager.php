...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify voyager asset path configs
    |
    */
    'meta_base_asset_path' => env('VOYAGER_META_ASSET_PATH', 'vendor/tcg/voyager/publishable/assets/js/'),
    'asset_path'           => env('VOYAGER_ASSET_PATH', 'vendor/tcg/voyager/publishable/assets/'),
