...
return [
    ...
    'default_search_key_ph'  => 'Αυτό το πεδίο θα είναι προεπιλεγμένο για αναζήτησση από την πλευρά του διακομιστή',
    ...
    'create_migration'       => 'Δημιουργεία migration για αυτόν τον πίνακα;',
    ...
    'soft_deletes_on'        => 'Εμφάνιση διεγραμμένων',
    'soft_deletes_off'       => 'Απόκρυψη διεγραμμένων',
    'updated_order'          => 'Η ταξινόμηση ενημερώθηκε επιτυχώς',
    'url_slug'               => 'URL Slug (πρέπει να είναι μοναδικό)',
    'url_slug_ph'            => 'URL slug (π.χ. posts)',
];
