...
return [
    ...
    'error_may_exist'        => 'Μπορεί να υπάρχει ήδη αρχείο ή φάκελος με αυτό το όνομα. Παρακαλούμε διαλέξτε ένα άλλο όνομα ή διαγράψτε το άλλο αρχείο.',
    ...
    'folder_exists_already'  => 'Συγγνώμη, αυτός ο φακελος υπάρχει ήδη, παρακαλούμε διαγράψτε τον φάκελο πρώυα αν θέλετε να τον δημιουργήσετε ξανά.',
