...
return [
    ...
    'media' => [
        ...
        'error_deleting_folder'  => 'Извините, что-то пошло не так ' . 'с удалением папки, '.
                                    'проверьте права доступа',
        'error_may_exist'        => 'Файл или папка с таким именем уже существуют. ' . 'Выберите другое имя или удалите другой файл.',
    ...
    'analytics' => [
        ...
        'no_client_id'            => 'Чтобы просматривать аналитику, вам нужно получить идентификатор клиента (client id) Google Analytics и добавить его в свои настройки под ключом '.
