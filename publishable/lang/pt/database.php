...
return [
    ...
    'is_translatable'           => 'Pretende instalar traduções?',
    'relationship'              => [
        'relationship'         => 'Relacão',
        'relationships'        => 'Relacões',
        'has_one'              => 'Tem um',
        'has_many'             => 'Tem varios',
        'belongs_to'           => 'Pertence a',
        'belongs_to_many'      => 'Pertence a vários',
        ...
        'store_the'            => 'Guardar a(o)',
        'easy_there'           => 'Cuidado ',
        'before_create'        => 'Antes de criar uma nova relação, é preciso criar o BREAD.<br> Depois, volte a editar o BREAD para adicionar relações.<br> Obrigado.',
        'cancel'               => 'Cancelar',
        'add_new'              => 'Adicionar nova relação',
        'open'                 => 'Abrir',
        'close'                => 'Fechar',
        'relationship_details' => 'Detalhes das relações',
        'browse'               => 'Ver',
        'read'                 => 'Ler',
        'edit'                 => 'Editar',
        'add'                  => 'Adicionar',
        'delete'               => 'Apagar',
        'create'               => 'Criar uma relação',
