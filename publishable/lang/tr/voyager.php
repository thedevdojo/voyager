...
return [
    ...
    'generic' => [
        ...
        'edit'                   => 'Düzenle',
        'email'                  => 'E-mail',
        'error_deleting'         => 'Maalesef silerken bir sorun oluştu',
        'exception'              => 'İstisna - Hata',
        'featured'               => 'Öne Çıkan',
        'field_does_not_exist'   => 'Alan bulunamadı',
        'how_to_use'             => 'Nasıl kullanılır',
        'index'                  => 'İndeks',
        'internal_error'         => 'Kritik hata',
        'items'                  => 'Eşya(lar)',
        'keep_sidebar_open'      => 'Menüyü Açık Tut',
        'key'                    => 'Anahtar',
        'last_modified'          => 'Son güncellenem',
        'length'                 => 'Uzunluk',
        'login'                  => 'Giriş',
        'media'                  => 'Medya',
        'menu_builder'           => 'Menu Oluşturma',
        'move'                   => 'Taşı',
        'name'                   => 'İsim',
        'new'                    => 'Yeni',
        'no'                     => 'Hayır',
        ...
        'bulk_delete'             => 'Çöpleri Temizle',
        'bulk_delete_nothing'             => 'Çöp kutusunda hiçbir veri yok',
    ],

    'login' => [
        'loggingin'    => 'Giriş yap',
        'signin_below' => ' below: oturum aç',
        'welcome'      => "Sisteme hoşgeldiniz. ",
    ],
    ...
    'database' => [
        ...
        'relationship'              => [
            ...
            'is_used_to_reference' => 'Referans alınacak : ',
            'pivot_table'          => 'Pivot Tablo',
            'selection_details'    => 'Seçim Detayları',
            'display_the'          => 'Tablo',
            'store_the'            => 'Şurada sakla',
            'easy_there'           => 'Easy there Captain',
            'before_create'        => 'İlişki ağını kullanabilmek için ilk önce tabloda BREAD oluşturmalısınız.',
            'cancel'               => 'İptal Et ',
            'add_new'              => 'Ekle',
            'open'                 => 'Aç',
            'close'                => 'Kapat',
