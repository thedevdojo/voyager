...
return [
    ...
    'generic' => [
        ...
        'type'                   => 'Tip',
        'unsigned'               => 'İşaretsiz',
        'unstick_sidebar'        => "Sidebar'ı açık tut",
        'update'                 => 'güncelle',
    ...
    'profile' => [
        ...
        'password'      => 'Şifre',
        'password_hint' => 'Aynı kalması için boş bırakın',
        'role'          => 'Rol',
        'user_role'     => 'Kullanıcı Rolü',
    ],
    'settings' => [
        'usage_help'           => 'Her ayarın değerini sitenizdeki herhangi bir yerden çağırabilirisiniz',
        ...
        'delete_question'      => ' :setting ayarını silmek istediğine emin misin?',
    ...
    'media' => [
        ...
        'drag_drop_info'         => 'Dosyaları sürükleyip bırakın ya da yüklemek için aşağıya tıklayın',
        'error_already_exists'   => 'Maalesef aynı isme sahip bir dosya/klasör o klasör içinde zaten var',
        'error_creating_dir'     => 'Maalesef dizin oluşturuken bir şeyler yolunda gitmedi, '.'Lütfen izinlerinizi kontrol edin',
        'error_deleting_file'    => 'Bu dosyayı silerken bir sorun oluştu, lütfen izinlerinizi kontrol edin',
        'error_deleting_folder'  => 'Maalesef bu dizini silerken bir sorun oluştu, lütfen izinlerinizi kontrol edin',
        'error_may_exist'        => 'Dosya ya da Klasör aynı isimle zaten bulunuyor olabilir. Lütfen başka bir isim verin ya da diğer klasörü silin.',
        'error_moving'           => 'Bu dosya/klasör taşınırken bir sorun oluştu, lütfen doğru izinlere sahip olduğunuzdan emin olun',
        'error_uploading'        => 'Yükleme Hatası: Bilinmeyen bir hata oluştu!',
        'folder_exists_already'  => 'Maalesef bu dizinden var ama isterseniz silip tekrar oluşturabilirsiniz ',
        'image_does_not_exist'   => 'Resim bulanamadı',
        'image_removed'          => 'Resim silindi',
        'library'                => 'Medya silindi',
        'loading'                => 'ORTAM DOSYALARINIZ YÜKLENİYOR',
        ...
        'nothing_selected'       => 'Hiçbir Dosya/Klasör seçilmedi',
        'rename_file_folder'     => 'Dosya/Klasörü Yeniden Adlandır',
        ...
        'crop_override_confirm'  => 'Orijinal görselin üzerine yazılacak, emin misiniz?',
        'crop_image'             => 'Görseli Kırp',
        'success_crop_image'     => 'Görsel başarılı şekilde kırpıldı',
        'height'                 => 'Yükseklik: ',
        'width'                  => 'Genişlik: ',
    ],
