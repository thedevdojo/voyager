...
return [
    ...
    'bread' => [
        ...
        'delete_bread_conf'      => "Evet,BREAD'i sil",
        'delete_bread_quest'     => ":table tablosunda BREAD'i silmek istediğinizden eminmisiniz ? ",
        ...
        'policy_class'           => 'TR:Policy Class Name',
        'policy_name'            => 'TR:Policy Name',
        'policy_name_ph'         => 'TR:ex. \App\Policies\UserPolicy, if left empty will try and use the default',
    ...
    'error' => [
        ...
        'symlink_failed_text'    => 'Kayıp depolama alanı sembolik bağlantısını sizin için oluştururken sorun alıyoruz Sunucunuz bunu desteklemiyor görünüyor.',
