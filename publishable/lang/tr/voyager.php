...
return [
    ...
    'generic' => [
        ...
        'bulk_delete_confirm'    => 'Evet, şunları sil',
        'bulk_delete_nothing'    => 'Silmek için seçim yapmadınız',
        'builder'                => 'Kurucu',
        'cancel'                 => 'İptal',
        ...
        'select_group'           => 'Mevcut Bir Grubu Seç veya Yeni Ekle',
        'settings'               => 'Ayarlar',
    ...
    'media' => [
        ...
        'crop_override_confirm'  => 'Orjinal resmin üzerine yazacak, emin misniz?',
        'crop_image'             => 'Resmi Kırp',
        'success_crop_image'     => 'Resim başarıyla kırpıldı',
        'height'                 => 'Yükseklik: ',
        'width'                  => 'Genişlik: ',
    ],
    ...
    'database' => [
        ...
        'policy_name_ph'            => 'ex. \App\Policies\UserPolicy, eğer boş bırakılırsa varsayılan kullanılacak',
        'primary'                   => 'BİRİNCİL',
        ...
        'relationship'              => [
            ...
            'which_column_from'    => 'Şuradaki hangi sütundan',
            'is_used_to_reference' => 'şuna referans olarak kullanılacak',
            'pivot_table'          => 'Pivot Tablo',
            'selection_details'    => 'Seçim Detayları',
            'display_the'          => 'Şunu görüntüle',
            'store_the'            => 'Şunu kaydet',
            'easy_there'           => 'Sakin ol Kaptan',
            'before_create'        => 'Yeni bir ilişki başlatmak için önce BREAD oluşturmalısın.<br> Sonra, BREAD düzenlemeye dönüp ilişki oluşturabilirsin.<br> Teşekkürler.',
            'cancel'               => 'İptal',
            'add_new'              => 'Yeni ilişki ekle',
            'open'                 => 'Aç',
            'close'                => 'Kapat',
    ...
    'analytics' => [
        ...
        'no_client_id' => 'Analytics istatististiklerini görüntülemek için bir Google Analytics müşteri id (client id) oluşturmalı ve '.
            'bunu ayarlar bölümündeki şu kısma eklemelisiniz <code>google_analytics_client_id'.
            '</code>. Google Developer Console anahtar al:',
        'set_view'               => 'Görünüm seçin',
        'this_vs_last_week'      => 'Bu Hafta / Geçen Hafta',
        'this_vs_last_year'      => 'Bu Yıl / Geçen Yıl',
