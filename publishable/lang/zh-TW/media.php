...
return [
    ...
    'audio_support'          => '您的瀏覽器不支援播放音檔',
    'create_new_folder'      => '新增資料夾',
    'delete_folder_question' => '此操作將連同裡面的所有資料夾和資料一併刪除',
    'destination_folder'     => '目標資料夾',
    'drag_drop_info'         => '拖放資料或點擊下面的上傳',
    'error_already_exists'   => '對不起，相同名稱的資料 / 資料夾已存在。',
    'error_creating_dir'     => '對不起，新增資料夾似乎出了問題，請檢查您的權限',
    'error_deleting_file'    => '對不起，在刪除此資料時出現了錯誤，請檢查您的權限',
    ...
    'folder_exists_already'  => '對不起，資料夾已經存在，如果您想重新新增，請刪除該資料夾',
    ...
    'public_url'             => '公開 URL',
    'last_modified'          => '最後修改',
    'browser_video_support'  => '您的瀏覽器不支援播放影片',
    'browser_audio_support'  => '您的瀏覽器不支援播放影片',
    'width'                  => '寬度: ',
];
