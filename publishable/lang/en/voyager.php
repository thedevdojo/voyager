...
return [
    ...
    'database' => [
        ...
        'order_column_ph'           => 'Select the column where the order should be stored',
        'order_ident_column'        => 'Order ident column',
        'order_ident_column_ph'     => 'Select the column which is displayed on the order page',
