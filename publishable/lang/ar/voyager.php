...
return [
    ...
    'generic' => [
        ...
        'delete_question'        => 'هل أنت متأكد أنك تريد حذف هذا',
        'delete_this_confirm'    => 'نعم، احذف هذا',
        'deselect_all'           => 'إلغاء تحديد الكل',
        'download'               => 'تحميل',
        'edit'                   => 'تعديل',
        'email'                  => 'البريد الإلكتروني',
        'error_deleting'         => 'عذرا، يبدو أنه حدثت مشكلة أثناء حذف هذا',
        'exception'              => 'استثناء',
        'featured'               => 'مميز',
    ...
    'login' => [
        ...
        'welcome'      => 'مرحبا بكم في فوياجر. لوحة التحكم المكملة للارافيل',
    ],

    'profile' => [
        'avatar'        => 'الصورة الرمزية',
        'edit'          => 'تعديل ملفي الشخصي',
        'edit_user'     => 'تعديل المستخدم',
        'password'      => 'كلمه السر',
        'password_hint' => 'اتركها فارغة لعدم التعديل',
        'role'          => 'الدور',
    ...
    'settings' => [
        ...
        'already_at_top'       => 'هذا موجود بالفعل في أعلى القائمة',
        'already_at_bottom'    => 'هذا موجود بالفعل في أسفل القائمة',
        'moved_order_up'       => 'القيمة :name تم نقلها الى أعلى',
        'moved_order_down'     => 'القيمة :name تم نقلها الى أسفل',
    ...
    'media' => [
        ...
        'error_deleting_file'    => 'عذراً، يبدو أن هناك خطأ في حذف هذا الملف، يرجى التحقق من صلاحياتك',
        'error_deleting_folder'  => 'عذراً، يبدو أن هناك خطأ في حذف هذا المجلد، يرجى التحقق من صلاحياتك',
        'error_may_exist'        => 'قد يكون هناك ملف أو مجلد موجود بالفعل بهذا الاسم. الرجاء اختيار اسم آخر أو حذف الملف الآخر.',
        'error_moving'           => 'عذراً، يبدو أن هناك مشكلة في نقل هذا الملف/المجلد، يرجى التأكد من أن لديك الصلاحيات الصحيحة.',
    ...
    'menu_builder' => [
        ...
        'delete_item_question' => 'هل تريد بالتأكيد حذف عنصر القائمة هذا؟',
